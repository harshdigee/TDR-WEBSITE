...
export const Route = createFileRoute('/dental-rct-gurgaon')({
  head: () => ({
    meta: [
      { title: 'Painless Root Canal Treatment in Gurgaon — The Dental Roots' },
      { name: 'description', content: 'Painless single-visit root canal treatment in Gurgaon at The Dental Roots. Available at Sushant Lok, Golf Course Road, and Tata Primanti clinics.' },
    ],
  }),
  component: DentalRctGurgaonPage,
});
...
const testimonials = [
  { name: 'Vikas M.', text: 'The Golf Course Road clinic is so close to my office. Same-day appointment and painless RCT — couldn\'t ask for more!', rating: 5 },
  { name: 'Sunaina B.', text: 'The dental microscope treatment at The Dental Roots, Sushant Lok is absolutely top-notch. Zero pain, single visit.', rating: 5 },
  { name: 'Abhay R.', text: '3 clinics in Gurgaon means there\'s always one convenient for me. The specialist endodontist saved my tooth perfectly.', rating: 5 },
];

const faqs = [
  {
    q: 'Which Gurgaon clinics offer root canal treatment?',
    a: 'Root canal treatment is available at all three of our Gurgaon locations: Sushant Lok, Golf Course Road (Sector 56), and Tata Primanti.',
  },
  {
    q: 'Is single-visit root canal really possible?',
    a: 'Yes, in most cases our specialist endodontists complete the root canal in a single 60–90 minute appointment using rotary instrumentation and dental microscopes.',
  },
  {
    q: 'What are digital RVG X-rays?',
    a: 'RVG (Radio Visiograph) digital X-rays provide high-resolution images instantly with significantly less radiation than traditional X-rays, helping us diagnose and treat with precision.',
  },
];

const moreServices = [
  { name: 'Dental Implants Gurgaon', to: '/dental-implants-in-gurgaon' },
  { name: 'Dental Veneers Gurgaon', to: '/dental-veneers-gurgaon' },
        ...
        <div className="container mx-auto px-4 relative z-10">
          <ScrollReveal>
            <nav className="flex items-center gap-2 text-sm text-white/50 mb-6">
              ...
              <ChevronRight className="w-4 h-4" />
              <span className="text-primary">Root Canal Treatment Gurgaon</span>
            </nav>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              Painless Root Canal <span className="text-gradient">Treatment</span> in Gurgaon
            </h1>
            <p className="text-white/60 text-lg max-w-2xl">Single-visit, painless root canal treatment across 3 Gurgaon clinics — Sushant Lok, Golf Course Road, and Tata Primanti.</p>
          </ScrollReveal>
        </div>
      </section>
          ...
          <div className="lg:col-span-2 space-y-8">
            <ScrollReveal>
              <div className="space-y-4">
                <p className="text-white/80 text-lg leading-relaxed">The Dental Roots in Gurgaon offers single-visit, painless root canal treatments using state-of-the-art technology. Available at Sushant Lok, Golf Course Road, and Tata Primanti clinics.</p>
                <p className="text-white/80 leading-relaxed">Our specialist endodontists have treated thousands of complex root canal cases successfully. Using rotary endodontics, dental microscopes, and digital RVG X-rays, we deliver precise, comfortable treatment — saving teeth that might otherwise require extraction.</p>
              </div>
            </ScrollReveal>

            <ScrollReveal delay={0.1}>
              <h2 className="text-2xl font-bold text-white mb-6">Our Root Canal Advantages in Gurgaon</h2>
            ...
            <ScrollReveal delay={0.25}>
              <GlassCard className="p-8 text-center space-y-4 border-primary/20">
                ...
                <p className="text-white/60">Same-day appointments available at all 3 Gurgaon clinics.</p>
