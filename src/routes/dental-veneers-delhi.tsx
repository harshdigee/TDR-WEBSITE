...
export const Route = createFileRoute('/dental-veneers-delhi')({
  head: () => ({
    meta: [
      { title: 'Dental Veneers in Delhi — The Dental Roots' },
      { name: 'description', content: 'Custom porcelain veneers in Delhi at The Dental Roots, Panchsheel Park. Digital Smile Design preview. Expert cosmetic dentists.' },
    ],
  }),
  component: DentalVeneersDelhiPage,
});
...
const testimonials = [
  { name: 'Simran K.', text: 'My porcelain veneers look completely natural. The Digital Smile Design let me see exactly what I\'d look like beforehand!', rating: 5 },
  { name: 'Rahul D.', text: 'Expert cosmetic dentists in Delhi — the Panchsheel Park clinic did an exceptional job transforming my smile.', rating: 5 },
  { name: 'Neha A.', text: 'Worth every penny. My veneers are flawless and feel just like natural teeth. Highly recommend!', rating: 5 },
];

const faqs = [
  {
    q: 'How long do porcelain veneers last?',
    a: 'With proper care, porcelain veneers typically last 10–15 years. Avoid biting hard objects and maintain good oral hygiene for maximum longevity.',
  },
  {
    q: 'Is the veneer procedure painful?',
    a: 'Veneer placement involves minimal tooth preparation under local anaesthesia. Most patients experience little to no discomfort during or after the procedure.',
  },
  {
    q: 'Can I preview my new smile before veneers?',
    a: 'Yes! We use Digital Smile Design (DSD) to create a digital preview on photos of your face, so you can see your new smile before treatment begins.',
  },
];
...
function DentalVeneersDelhiPage() {
  return (
        ...
        <div className="container mx-auto px-4 relative z-10">
          <ScrollReveal>
            <nav className="flex items-center gap-2 text-sm text-white/50 mb-6">
              ...
              <ChevronRight className="w-4 h-4" />
              <span className="text-primary">Dental Veneers Delhi</span>
            </nav>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              Dental <span className="text-gradient">Veneers</span> in Delhi
            </h1>
            <p className="text-white/60 text-lg max-w-2xl">Custom-crafted porcelain veneers by expert cosmetic dentists in South Delhi. Preview your new smile with Digital Smile Design.</p>
          </ScrollReveal>
        </div>
      </section>
          ...
          <div className="lg:col-span-2 space-y-8">
            <ScrollReveal>
              <div className="space-y-4">
                <p className="text-white/80 text-lg leading-relaxed">Transform your smile with custom-crafted porcelain veneers in Delhi. Our cosmetic dentists at Panchsheel Park specialise in creating stunning, natural-looking smile transformations.</p>
                <p className="text-white/80 leading-relaxed">Digital Smile Design lets you preview your new smile before treatment begins. Each veneer is individually crafted from high-quality feldspathic or e.max porcelain to perfectly match your facial features and desired aesthetics.</p>
              </div>
            </ScrollReveal>

            <ScrollReveal delay={0.1}>
              <h2 className="text-2xl font-bold text-white mb-6">Our Veneer Expertise</h2>
            ...
            <ScrollReveal delay={0.25}>
              <GlassCard className="p-8 text-center space-y-4 border-primary/20">
                <h2 className="text-2xl font-bold text-white">Get Your Dream Smile with Veneers</h2>
                <p className="text-white/60">Book a free smile design consultation and preview your new look today.</p>
